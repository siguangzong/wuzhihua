...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('version', '0002_delete_paperlessversion'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(4, '人大温州平阳版'), (9, '履职宁波政协版'), (5, '政协舟山版'), (7, '标准宁波市场监管局版'), (1, '人大宁波市版'), (3, '政协宁波版'), (6, '标准宁波经信委版'), (8, '履职宁波人大版'), (2, '人大宁波辖区版')], default=1, verbose_name='版本类型')),
                ...
                ('qr_code', models.ImageField(blank=True, null=True, upload_to='qr_code', verbose_name='二维码')),
