# Generated by Django 2.0.6 on 2019-01-14 07:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(5, '政协舟山版'), (3, '政协宁波版'), (8, '履职宁波人大版'), (7, '标准宁波市场监管局版'), (2, '人大宁波辖区版'), (9, '履职宁波政协版'), (1, '人大宁波市版'), (4, '人大温州平阳版'), (6, '标准宁波经信委版')], default=1, verbose_name='版本类型')),
